...
npx vitest run     # run 469 tests (41 test files)
```
...
- **Current suite:** 469 tests across 41 files — all green. Compare against this number before blaming your own change; verify by stashing and running on `main` rather than assuming.
