...
const TODO_ITEMS: TodoItem[] = [
  ...
  },
  {
    ...
    phase: "P3",
    status: "done",
    detail: "DONE 2026-08-20. James chose personal frequency over community consensus — on a personal profile the interesting question is what THIS person thinks restaurants are. The ranking was the easy half: levelForGap (the iOS rule, absolute distance from the leader) degenerates on real frequencies — 93, 88, 58 ... 8 puts the top tag at L1 and every other tag at L5. levelForShare uses quintiles of the leader instead, giving L1x2 L2x3 L3x2 L4x1 L5xrest. No numerals rendered; the design spec forbids them. Todo 125.",
    file: "src/lib/api/index.ts",
    date: "",
  },
  {
